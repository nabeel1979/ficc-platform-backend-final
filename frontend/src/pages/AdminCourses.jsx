              ...
              <div key={c.id} style={{background:'#fff',borderRadius:16,overflow:'hidden',boxShadow:'0 2px 10px rgba(44,62,107,0.07)',border:'1px solid #e5e7eb'}}>
                ...
                <div style={{padding:'14px 16px'}}>
                  ...
                  <div style={{display:'flex',gap:6,flexWrap:'wrap'}}>
                    ...
                    <button onClick={() => { const t = encodeURIComponent(localStorage.getItem('ficc_token')||''); window.open(`/badges.html?course=${c.id}&t=${t}`, '_blank') }} style={{flex:1,padding:'7px',background:'#f0f9ff',color:'#0369a1',border:'none',borderRadius:8,cursor:'pointer',fontFamily:'Cairo,sans-serif',fontWeight:700,fontSize:11}}>🪪 Badges</button>
