...
const FIELDS = {
  ...
  traderdirectory: [
    {key:'companyName',label:'الاسم التجاري',required:true},
    {key:'businessType',label:'التصنيف',type:'select',options:['شركة','مكتب','محل تجاري','صيدلية','مستوصف','مطعم','فندق','مصنع','مؤسسة','وكالة','أخرى']},
    {key:'ownerName',label:'اسم المالك'},
    {key:'tradeCategory',label:'القطاع',type:'select',options:['تجارة عامة','استيراد وتصدير','مواد غذائية','مواد بناء','إلكترونيات وتقنية','ملابس وأزياء','أثاث ومفروشات','معدات وآليات','أدوية ومستلزمات طبية','مجوهرات وساعات','سيارات وقطع غيار','خدمات مالية','خدمات قانونية','خدمات هندسية','تعليم وتدريب','سياحة وسفر','مطاعم وفنادق','تشييد وبناء','طاقة وكهرباء','زراعة ومواد زراعية','أخرى']},
    {key:'governorate',label:'المحافظة',type:'select',options:govOptions},
    {key:'area',label:'المنطقة'},
    {key:'address',label:'العنوان التفصيلي',type:'textarea'},
    {key:'description',label:'نبذة عن النشاط التجاري',type:'textarea'},
    {key:'phone',label:'الهاتف',type:'tel'},
    {key:'mobile',label:'الموبايل',type:'tel'},
    {key:'email',label:'البريد الإلكتروني',type:'email'},
    {key:'website',label:'الموقع الإلكتروني',placeholder:'https://'},
    {key:'_logo',label:'شعار المنشأة (لوغو)',type:'logo'},
    {key:'_social',label:'روابط التواصل الاجتماعي',type:'social'},
            ...
            <div style={{background:'#F5F7FA',borderRadius:'12px',padding:'16px',marginBottom:'16px'}}>
              ...
              {Object.entries(selected.formData||{}).map(([k,v])=>{
                ...
                const labels = {
                  ...
                  // دليل التجار
                  tradeName:'الاسم التجاري', ownerName:'صاحب العمل',
                  businessType:'نوع النشاط التجاري', tradeCategory:'التصنيف التجاري',
