...
function MapSection() {
  return (
    <section style={{ background: '#1a2a4a', padding: '40px 20px' }}>
      <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
        <div style={{ textAlign: 'center', marginBottom: '20px' }}>
          <h2 style={{ fontSize: '22px', fontWeight: '800', color: '#fff', marginBottom: '6px' }}>📍 موقعنا</h2>
          <p style={{ color: 'rgba(255,255,255,0.6)', fontSize: '13px' }}>اتحاد الغرف التجارية العراقية — شارع السعدون، الرصافة، بغداد</p>
        </div>
        <a href="https://maps.app.goo.gl/HJHisaK4AsEEzhnC8?g_st=awb" target="_blank" rel="noreferrer"
          style={{ display: 'block', borderRadius: '16px', overflow: 'hidden', boxShadow: '0 8px 32px rgba(0,0,0,0.4)', marginBottom: '16px', cursor: 'pointer', position: 'relative', height: '300px', background: 'linear-gradient(135deg,#2C3E6B,#4A6FA5)', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 12 }}>
          <div style={{ fontSize: 56 }}>📍</div>
          <div style={{ color: '#fff', fontSize: 16, fontWeight: 800 }}>اتحاد الغرف التجارية العراقية</div>
          <div style={{ color: 'rgba(255,255,255,0.7)', fontSize: 13 }}>شارع السعدون، الرصافة، بغداد</div>
          <div style={{ background: '#FFC72C', color: '#1a1a2e', padding: '10px 24px', borderRadius: 12, fontWeight: 800, fontSize: 14, fontFamily: 'Cairo,sans-serif', marginTop: 4 }}>
            🗺️ اضغط لفتح الموقع
          </div>
        </a>
      </div>
